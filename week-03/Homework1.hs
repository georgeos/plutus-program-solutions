...
mkValidator dat () ctx =
                        traceIfFalse "beneficiary1's signature missing or deadline already passed" signedByBeneficiary1 && deadlineReached1 ||
                        traceIfFalse "beneficiary2's signature missing or deadline not reached" signedByBeneficiary2 && deadlineReached2
